          ...
          {safetyPractices.map((item, index) => {
            ...
            return (
              <div
                ...
                className="bg-[#F7F7F7] border border-[#DDDEDF] p-4 sm:p-6 flex flex-col justify-between hover-gradient-border border-transparent transition-colors group rounded-2xl"
              >
                <div>

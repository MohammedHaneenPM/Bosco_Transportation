    ...
    <main className="flex-1 pt-24 bg-[#F6F7F8]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
            ...
            <div className="flex flex-col items-center text-center p-6 xl:p-8 border-b border-[#DDDEDF] md:border-r lg:border-b-0">
              <Route className="w-8 h-8 text-[#BF0505] mb-4" strokeWidth={1.5} />
              <div className="text-xs text-[#050505] font-bold uppercase tracking-wide mb-1">ACROSS</div>
              <div className="text-2xl font-extrabold text-[#BF0505] font-grotesk leading-none mb-1">ONTARIO</div>
            ...
            <div className="flex flex-col items-center text-center p-6 xl:p-8 border-b border-r border-[#DDDEDF] md:border-r-0 md:border-b lg:border-r lg:border-b-0">
              <ShieldCheck className="w-8 h-8 text-[#BF0505] mb-4" strokeWidth={1.5} />
              <div className="text-2xl font-extrabold text-[#050505] font-grotesk leading-none mb-1">SAFETY</div>
              <div className="text-sm font-bold text-[#BF0505] uppercase tracking-wider mb-1">FIRST</div>
            ...
            <div className="flex flex-col items-center text-center p-6 xl:p-8 border-b border-[#DDDEDF] md:border-b-0 md:border-r lg:border-r">
              <Clock className="w-8 h-8 text-[#BF0505] mb-4" strokeWidth={1.5} />
              <div className="text-2xl font-extrabold text-[#BF0505] font-grotesk leading-none mb-1">ON-TIME</div>
            ...
            <div className="flex flex-col items-center text-center p-6 xl:p-8 col-span-2 md:col-span-1 border-[#DDDEDF]">
              <Settings className="w-8 h-8 text-[#BF0505] mb-4" strokeWidth={1.5} />
              <div className="text-2xl font-extrabold text-[#BF0505] font-grotesk leading-none mb-1">MULTIPLE</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5">
              ...
              <div className="p-6 bg-[#F7F7F7] border-l-2 border-[#BF0505] text-sm text-[#373737] leading-relaxed">
            ...
            <div className="lg:col-span-7 space-y-6 text-[#373737] text-sm sm:text-base leading-relaxed">
              <p>
                Bosco Transportation is a family-owned company committed to providing reliable, professional, and personalized transportation services across Canada. Our family values are at the heart of everything we do — from the way we serve our customers to the relationships we build along the way.
              </p>
              <p>
      ...
      <section className="py-24 bg-[#FEFEFE] border-b border-[#DDDEDF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Mission Card */}
            <div className="p-8 sm:p-10 bg-[#F7F7F7] border border-[#DDDEDF] relative group hover:border-[#BF0505]/60 transition-colors rounded-2xl">
              <div className="w-12 h-12 bg-[#EDEDED] border border-[#DDDEDF] text-[#BF0505] flex items-center justify-center mb-6 rounded-full">
                <Target className="w-6 h-6" />
              </div>
              <span className="text-xs font-mono text-[#BF0505] uppercase tracking-widest block mb-2">
                Our Purpose
              </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              >
                <div>
                  <span className="text-xs font-mono text-[#BF0505] font-bold block mb-2">
                    0{idx + 1}
                  </span>
      ...
      <section className="py-20 bg-[#F7F7F7] border-t border-[#DDDEDF] text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link
            href="/#quote"
            className="inline-flex items-center gap-2.5 px-8 py-4 bg-[#BF0505] hover:bg-[#C5161D] text-white text-xs font-mono uppercase tracking-wider font-bold transition-colors shadow-lg rounded-full"
          >
